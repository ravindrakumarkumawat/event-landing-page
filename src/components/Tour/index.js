...
const Tour = () => {
  return (
    ...
    <div className="container content padding-64" style={{ maxWidth:"800px"}}>
      ...
      <ul className="ul border white text-grey">
        <li className="padding">September <span className="tag red margin-left">Sold out</span></li>
        <li className="padding">October <span className="tag red margin-left">Sold out</span></li>
      ...
      <div className="row-padding padding-32" style={{margin:"0 -16px"}}>
        <div className="third margin-bottom">
          <img src="/w3images/newyork.jpg" alt="New York" style={{width:"100%"}} className="hover-opacity" />
        ...
        <div className="third margin-bottom">
          <img src="/w3images/paris.jpg" alt="Paris" style={{width:"100%"}} className="hover-opacity" />
          <div className="container white">
            <p><b>Paris</b></p>
        ...
        <div className="third margin-bottom">
          <img src="/w3images/sanfran.jpg" alt="San Francisco" style={{width:"100%"}} className="hover-opacity" />
          <div className="container white">
